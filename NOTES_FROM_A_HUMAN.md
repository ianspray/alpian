...
However, it does actually work, and given the awful holes in most Radxa documentation, a working result is better than a perfectly well written project that fails to do anything useful.
